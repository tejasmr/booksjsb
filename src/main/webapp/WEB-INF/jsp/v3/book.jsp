...
<body class="bg-light">
	...
	<div class="col-md-8 order-md-1">
		...
		<c:url var="addBookUrl" value="/v3/book/addBook" />
	...
	<table id="sortTable"
		...
		<thead>
			<tr>
				...
				<th>Name 
					<form:form action="/v3/book/" method="get"
			...
			<c:forEach items="${books}" var="book">
				<tr>
					...
					<td data-label="Delete"><form:form id="a"
							action="/v3/book/deleteBook?isbn=${book.isbn}" method="post"
							style="all:unset">
							<input class="btn btn-danger" type="submit" value="Delete"
								style="-universal-margin: 0px" />
						</form:form></td>
					<td data-label="Update"><form:form id="a"
							action="/v3/book/updateBook?isbn=${book.isbn}" method="get"
							style="all:unset">
